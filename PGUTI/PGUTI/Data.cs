...
namespace PGUTI
{
    public static class Data
    {
        ...
        {
            return String.Format(" (((start_date < '{1}' ) and (end_date is null)) or  ((start_date between '{0}' and '{1}') or (end_date between '{0}' and '{1}'))) ", ReverseDateTime(startDate), ReverseDateTime(endDate));
        }
